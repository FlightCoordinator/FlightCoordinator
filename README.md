...
This project is an automated flight manager app for final year computer engineering project. The project is a full-stack application consisting of a Spring Boot backend, a React/Next.js frontend with TypeScript, and Python scripts for automation related algorithms.
